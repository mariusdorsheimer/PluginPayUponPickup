...
namespace PluginPayUponPickup\Providers;
...
use PluginPayUponPickup\Helper\PayUponPickupHelper;
use PluginPayUponPickup\Methods\PayUponPickupPaymentMethod;
...
class PayUponPickupServiceProvider extends ServiceProvider {
    ...
    public function boot(PayUponPickupHelper $paymentHelper,
        ...
        $payContainer->register(
            'plenty_payuponpickup::PAYUPONPICKUP',
            PayUponPickupPaymentMethod::class,
